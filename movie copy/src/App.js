...
function App() {
  const moives = [
    // {"Name":"BadBoy1", "Description":"Will Smith and Martin Lawrence team up as partners in crime, crime-fighting that is, in this action-packed flick about a couple of good guys who are real Bad Boys", "image":"https://images.moviesanywhere.com/8fde25260b52fe9182e6ce5002c79d88/98b2a402-ab7e-4b36-a642-d151428bf426.jpg"}
  ...
  return (
    <div className="App">
      ...
      <div class="row">
      {
      moives.map(element => <MovieComponent MovieName = {element["title"]} MovieDec={element["overview"]} Movieimage={element["poster"]}  />)
      }
      </div>
      </div>
    </div>
